...
### 1. Testing the WhiteListed path for api/unlimited   
   ...
   ![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images/Capture_UnlimitedCalls.png "image")
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images/Capture_api_globallylimited_id.png "image")		
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images/Capture_api_globallylimited_id_throttled.png "image")	
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_3successinsteadof5.png "image")	
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_api_globallylimited_id_hrourlyrate.png "image")	
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_succuessRateLimitHeaders.png "image")		
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_upperrateremaining.png "image")	
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_throttledheaders1.png "image")	
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_api_globallylimited_get.png "image")
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_attributelimitedoncontroller.png "image")
...
![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_attributeonaction.png "image")
   
   Now within the same minute type 
        **sb -u http://localhost:50091/api/attributelimited/1 -n 1 -h** and here is the result
   

![alt text](https://github.com/domain-group/domain-rate-limiting/blob/master/samples/Images//Capture_attributeviolatedheader.png "image")
